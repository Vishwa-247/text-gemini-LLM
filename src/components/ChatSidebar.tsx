...
const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  return <>
      <div className={`fixed inset-0 bg-background/80 backdrop-blur-sm z-30 lg:hidden ${isMobileSidebarOpen ? 'block' : 'hidden'}`} onClick={onCloseMobileSidebar} />
      <aside className={`
        ...
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <ModelSelector selectedModel={selectedModel} onSelectModel={onSelectModel} onNewChat={onNewChat} />
          
          <Separator className="my-7 mx-0" />
          
          <ChatHistoryList chats={chats} currentChatId={currentChatId} onSelectChat={onSelectChat} onDeleteChat={onDeleteChat} isLoading={isLoading} />
