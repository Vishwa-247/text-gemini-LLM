  ...
  return <div className="px-2 py-2">
      ...
      <ScrollArea className="h-[140px]">
        <div className="space-y-1 pr-2">
          {models.map(model => <Button key={model.id} variant={selectedModel === model.id ? "secondary" : "ghost"} className="w-full justify-start gap-2" onClick={() => handleModelSelect(model.id)}>
